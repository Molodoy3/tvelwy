...
require_once $_SERVER['DOCUMENT_ROOT'] .("/amocrm/vendor/autoload.php");
    ...
    $subdomain = 'artemnikonov2005'; // это поддомен админки амосрм
    $login = 'artem.nikonov.2005@bk.ru';
    $api_key = 'ggfkHlqk8P67l8MNs5sQzOOF1ITkV0cxTIO5IaAlycZevxzJKFklWUCCfGYngDpS'; // получаем API с помощью  AMOCRM.widgets.system.amohash  - вбиваем в консоль браузера в кабинете амосрм

    // получаем данные из формы
    $phone = 89991112233;
    $name = 'artem.nikonov.2005@bk.ru';
    $country = 'страна';
